        ...
        <div className="border-b flex justify-between px-10 py-1">
            <Link to={"/blogs"}>
                <div className="flex items-center cursor-pointer">
                    <svg width="40px" height="40px" viewBox="0 -55 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
                        <g>
                    ...
                    <h2 className="ml-2 font-serif text-2xl font-extrabold">Medium</h2>
                </div>
